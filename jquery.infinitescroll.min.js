...
/*!
   ...
   --------------------------------
*/
!function(t){t.extend(t.infinitescroll.prototype,{_setup_twitter:function(){var t=this.options,e=this;jQuery(t.nextSelector).click(function(t){t.metaKey||t.shiftKey||(t.preventDefault(),e.retrieve())}),e.options.loading.start=function(t){t.loading.msg.appendTo(t.loading.selector).show(t.loading.speed,function(){e.beginAjax(t)})}},_showdonemsg_twitter:function(){var e=this.options;e.loading.msg.find("img").hide().parent().find("div").html(e.loading.finishedMsg).animate({opacity:1},2e3,function(){t(this).parent().fadeOut("normal")}),t(e.navSelector).fadeOut("normal"),e.errorCallback.call(t(e.contentSelector)[0],"done")}})}(jQuery);
